...
class TestInstruments:
    ...
    def test_get_instr_from_filepath(self):
        path = (
            ...
            / "Titan/***REMOVED***/***REMOVED***/***REMOVED***/4_330mm.dm3"
        )
    ...
    def test_instrument_datetime_localization(self):
        ...
        assert _strftime(instr.localize_datetime(dt_naive)) == "2021-11-26 12:00:00 EST"
        assert _strftime(instr.localize_datetime(dt_mt)) == "2021-11-26 14:00:00 EST"
        assert _strftime(instr.localize_datetime(dt_et)) == "2021-11-26 12:00:00 EST"
    ...
    def test_instrument_datetime_localization_str(self):
        ...
        assert instr.localize_datetime_str(dt_naive) == "2021-11-26 12:00:00 EST"
        assert instr.localize_datetime_str(dt_mt) == "2021-11-26 14:00:00 EST"
        assert instr.localize_datetime_str(dt_et) == "2021-11-26 12:00:00 EST"

    def test_instrument_from_api_url(self):
        returned_item = get_instr_from_api_url(
            os.environ.get("NEMO_address_1") + "tools/?id=10",
        )
        assert returned_item == instrument_db["testsurface-CPU_P1111111"]

    def test_instrument_from_api_url_none(self):
        returned_item = get_instr_from_api_url(
            "https://***REMOVED***/api/tools/?id=-1",
        )
