...
The project is actively maintained and continues to serve NIST Nexus Microscopy Facility Laboratory Information Management System (NexusLIMS), this project is currently managed by the NIST Associate Director of Laboratory Programs Research Data and Computing Office in coordination with the Material Measurement Laboratory in support of ongoing Microscopy Research Data Management (RDM) at NIST.

Originally developed by the NIST Material Measurement Laboratory Office of Data and Informatics and described in the following *Microscopy and Microanalysis* article: 
