                            ...
                            <xsl:if test="boolean($hasMap)">
                                ...
                                <map name='{$mapName}' id='{$mapName}'>
                                    <xsl:for-each select="map/area">
                                        <area alt="{$mainFile}" href="{replace(@href, concat(substring-before($mainFile, $extension), $intermediateXmlExtension, '#'), '#')}" coords="{@coords}"/>
                                    </xsl:for-each>
                                </map>
                            </xsl:if>
                        </xsl:otherwise>
                ...
                <ul class="schemaHierarchy">
                    <li class="internal">
                        ...
                        <p class="componentTitle">
                          ...
                          <a href="{concat('#', $schemaHierarchy/@refId)}" 
