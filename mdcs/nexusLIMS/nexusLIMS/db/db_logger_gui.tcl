...
#  Dec 06, 2019 11:41:46 AM MST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 350x450+538+141
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ###################
    place $top.tLa43 \
        -in $top -x 50 -y 25 -width 250 -relwidth 0 -height 100 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tLa44 \
        -in $top -x 25 -y 150 -width 300 -relwidth 0 -height 16 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tBu45 \
        -in $top -x 125 -y 375 -width 100 -relwidth 0 -height 50 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tLa45 \
        -in $top -x 25 -y 185 -width 300 -relwidth 0 -height 16 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tLa46 \
        -in $top -x 25 -y 215 -width 300 -relwidth 0 -height 16 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tLa47 \
        -in $top -x 25 -y 245 -width 300 -relwidth 0 -height 16 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tLa48 \
        -in $top -x 25 -y 270 -width 300 -relwidth 0 -height 80 -relheight 0 \
        -anchor nw -bordermode ignore 
