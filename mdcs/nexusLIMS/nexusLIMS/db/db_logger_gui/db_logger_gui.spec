...
exe = EXE(pyz,
          ...
          a.binaries + [
              ...
              'M:\\db\\arrow-alt-circle-right.png' if on_vm else 'Z:\\tmp\\db\\arrow-alt-circle-right.png',
              'DATA'),
              ('arrow-alt-circle-left.png',
              'M:\\db\\arrow-alt-circle-left.png' if on_vm else 'Z:\\tmp\\db\\arrow-alt-circle-left.png',
              'DATA'),
              ('error-icon.png',
              'M:\\db\\error-icon.png' if on_vm else 'Z:\\tmp\\db\\error-icon.png',
              'DATA'),
              ('file-plus.png',
              'M:\\db\\file-plus.png' if on_vm else 'Z:\\tmp\\db\\file-plus.png',
              'DATA'),
              ('pause.png',
              'M:\\db\\pause.png' if on_vm else 'Z:\\tmp\\db\\pause.png',
              'DATA'),
              ],
          a.zipfiles,
          a.datas,
